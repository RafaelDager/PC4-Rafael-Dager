...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Blog Rafael</h1>", unsafe_allow_html=True)
    ...
    col1.image("fotoperfil.jpeg", caption='mi cara', width=300)
    ...
    texto = """
    Hola, soy Rafael Dager, soy alumno de la Pontificia Universidad Catolica Del Peru y estudio publicidad. Tengo 21 años y mis pasatiempos son hacer música e ir al gimnasio. 
    """
    ...
    texto_2 = """
    Mi experiencia aprendiendo a programar fue un poco dificil porque fue algo completamente nuevo para mi 
    Sin embargo, pude aprender nociones basicas de la programacion en python de manera que pude comprender mejor
    como es que se desarrolla el mundo de la programacion.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Video explicacion del uso de condicionales en python</h2>", unsafe_allow_html=True)
    ...
    st.video("https://youtu.be/8akdCmp2x1w")

    st.markdown("<h2 style='text-align: center;'>Video uso de bucle for y bucle while</h2>", unsafe_allow_html=True)
    st.video("https://youtu.be/Fxgp6dDXe1c")
    ...
    graficos = ['grafico histograma Real Madrid', 'Gráfico de pastel partidos barcelona', 'Gráfico de barras promedio de tarjetas rojas', 'mapas peliculas']
    ...
    if grafico_seleccionado == 'grafico histograma Real Madrid':
        ...
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Aquí debe ir una breve interpretación de tu gráfico</div>", unsafe_allow_html=True)
        st.image("grafico_2.png", caption='Gráfico de barras promedio de tarjetas rojas', width=500)
        pass
    elif grafico_seleccionado == 'mapas peliculas':
